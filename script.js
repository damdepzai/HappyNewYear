...
const WIDTH =375;
const HEIGHT =667;
const NUMBER_OF_PARTICLES = 22 // 1 quả pháo có 15 tia
const PARTICLE_SIZE = 3.2; // độ to của pháo hoa
const PARTICLE_CHANGE_SIZE_SPEED  = 0.07; // cho hat chay nhanh voi nho
const PARTICLE_CHANGE_SPEED  = 0.03; // độ nổ to của pháo hoa
const PARTICLE_MIN_SPEED  = 2.2; //tốc độ bắn ít nhất là 3
const GRAVITY = 0.06;
// 2  hằng số này sẽ quyết định đuôi dài or không
const DOT_CHANGE_SIZE_SPEED = 0.09; // số càng nhỏ đuôi càng dài
const DOT_CHANGE_ALPHA_SPEED = 0.05; // độ mờ của đuôi
...
class Particle {
    constructor(bullet, deg) {
        ...
        this.speed = Math.random() * 3 + PARTICLE_MIN_SPEED; // chỉnh để quả bắn sẽ tròn hơn
...
class firework {
    ...
    draw() {
        ...
        // Create gradient
        // let grd = this.ctx.createLinearGradient(0,0,WIDTH,0);
